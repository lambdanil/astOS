...
def live_unlock():
    ...
    part = get_part()
    os.system(f"chattr -RV -i /.overlays/overlay-{tmp}/usr > /dev/null 2>&1")
    os.system(f"mount {part} -o subvol=@home /.overlays/overlay-{tmp}/home > /dev/null 2>&1")
    os.system(f"mount {part} -o subvol=@tmp /.overlays/overlay-{tmp}/tmp > /dev/null 2>&1")
    os.system(f"mount {part} -o subvol=@var /.overlays/overlay-{tmp}/var > /dev/null 2>&1")
    os.system(f"mount {part} -o subvol=@etc /.overlays/overlay-{tmp}/etc > /dev/null 2>&1")
    os.system(f"mount --bind /.overlays/overlay-{tmp} /.overlays/overlay-{tmp}")
