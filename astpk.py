...
def live_unlock():
    ...
    part = get_part()
    os.system(f"chattr -RV -i /.overlays/overlay-{tmp}/usr > /dev/null 2>&1")
    os.system(f"rm -rf /.overlays/overlay-{tmp}/home")
    os.system(f"ln -s /home /.overlays/overlay-{tmp}/home")
        os.system(f"rm -rf /.overlays/overlay-{tmp}/tmp")
    os.system(f"ln -s /tmp /.overlays/overlay-{tmp}/tmp")
        os.system(f"rm -rf /.overlays/overlay-{tmp}/var")
    os.system(f"ln -s /var /.overlays/overlay-{tmp}/var")
        os.system(f"rm -rf /.overlays/overlay-{tmp}/etc")
    os.system(f"ln -s /etc /.overlays/overlay-{tmp}/etc")
    os.system(f"mount --bind /.overlays/overlay-{tmp} /.overlays/overlay-{tmp}")
